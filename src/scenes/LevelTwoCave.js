class LevelTwoCave extends Phaser.Scene {
    ...
    create() {
        ...
        const tileset = caveTwoMap.addTilesetImage("CaveLevelTwoTopLayer", "cave2Background");
        // this is a layer within the tiled project
        const backgroundLayer1 = caveTwoMap.createStaticLayer("CaveBackground", tileset, 0, 0);
